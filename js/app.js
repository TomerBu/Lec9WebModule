//read the key from stroage:
var name = localStorage.getItem('userName');
//name = 'null' //null

//if we have a value (name != null)
if (name != 'null') {
    alert('Welcome back, ' + name)
}

//(js) show an alert when the button is clicked:
$('#myBtn').on('click', function () {
    //local variable (משתנה מקומי בתוך הפונק)
    var name = $('#myInput').val(); //read the value into a var -> name

    //נשמור את הערך של שם המשתמש:
...
console.log(readCarsObject);//an object
